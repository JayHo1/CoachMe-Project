...
// http://stackoverflow.com/questions/8790752/callback-of-animate-gets-called-twice-jquery
    ...
    var scrollLeft = function () {
        ...
        if (i2 == 0)
            $('#footer .footer-smart-object').addClass('active');
        if (i1 == 2)
            $('#footer div').removeClass('active');
        if (i2 == 1)
            $('#footer .footer-smart-object2').addClass('active');
        if (i1 == 3)
            $('#footer div').removeClass('active');
        if (i2 == 2)
            $('#footer .footer-smart-object3').addClass('active');
        if (i1 == 4)
            $('#footer div').removeClass('active');
        if (i2 == 3)
            $('#footer .footer-smart-object4').addClass('active');
    };
    ...
    var scrollRight = function () {
        ...
        if (i1 == 3)
            $('#footer div').removeClass('active');
        if (i2 == 4)
            $('#footer .footer-smart-object5').addClass('active');
    };
